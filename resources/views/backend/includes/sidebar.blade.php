<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
    ...
    <ul class="c-sidebar-nav">
        ...
        <li class="c-sidebar-nav-item">
            <x-utils.link class="c-sidebar-nav-link" :href="route('admin.gallery')" :active="activeClass(Route::is('admin.gallery'), 'c-active')"
                icon="c-sidebar-nav-icon cil-speedometer" :text="__('Gallery')" />
        </li>
